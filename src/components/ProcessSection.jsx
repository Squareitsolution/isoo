  ...
  const steps = [
    {
      ...
      title: 'Consultation',
      description:
        'We begin with a detailed consultation to understand your business needs, goals, and current compliance status.',
      color: 'bg-blue-600',
    },
    {
      number: '02',
      ...
      title: 'Documentation',
      description:
        'Our experts assist you in preparing and organizing all necessary documentation required for certification.',
      color: 'bg-green-600',
    },
    {
      number: '03',
      ...
      description:
        'Comprehensive audit is conducted to ensure your systems meet all ISO standards and compliance requirements.',
      color: 'bg-orange-600',
    },
    {
      number: '04',
      ...
      description:
        'Upon successful completion, you receive your official ISO certification and ongoing support.',
      color: 'bg-purple-600',
    },
  ];
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
            ...
            {steps.map((step, index) => {
              ...
              return (
                <div key={index} className="relative">
                  ...
                  <div className="flex justify-center mb-6">
                    <div
                      className={`${step.color} w-24 h-24 rounded-full flex items-center justify-center shadow-xl relative z-10`}
                    >
        ...
        <div
          className={`lg:hidden transition-all duration-1000 delay-300 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'
          }`}
        >
                ...
                return (
                  <div key={index} className="relative flex gap-6">
                    ...
                    <div className="flex flex-col items-center flex-shrink-0">
                      ...
                      {/* Icon Circle */}
                      <div
                        className={`${step.color} w-20 h-20 rounded-full flex items-center justify-center shadow-xl relative z-10`}
                      >
