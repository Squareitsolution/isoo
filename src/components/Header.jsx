    ...
    <header className="w-full bg-white shadow-md sticky top-0 z-50">
      ...
      <div className="bg-blue-900 text-white py-2 px-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center text-sm">
          <a href="mailto:info@globallegitsolutions.com" className="flex items-center gap-2 hover:text-blue-200 transition">
            <Mail size={16} />
            <span className="hidden sm:inline">info@globallegitsolutions.com</span>
          </a>
        ...
        {isMenuOpen && (
          <nav className="lg:hidden mt-4 pb-4 border-t border-gray-200 pt-4">
            <div className="flex flex-col gap-4">
              ...
              <button className="bg-blue-900 text-white px-6 py-2.5 rounded-md hover:bg-blue-800 transition-colors font-medium w-full">
                Get Quote
              </button>
            </div>
          </nav>
